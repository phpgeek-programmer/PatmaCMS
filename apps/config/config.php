...
/**
 * Variabel konfigurasi yang diperlukan untuk menjalankan aplikasi
 *
 * Semua variabel konfigurasi yang tidak didefinisikan di file lainnya di tentukan
 * disini
 *
 * PHP version 5
 *
...
/*
 * -------------------------------------------------------------------
 *  Atur nilai variabel konfigurasi disini
 * -------------------------------------------------------------------
 */
